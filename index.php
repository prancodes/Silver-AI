...
<body>
    ...
    <div class="welcome-tab animation">
        <div class="wc-text-section">
            ...
            <div class="wc-btns">
                ...
                <a href="./auth/signup.php"><div class="btn-primary wc-getStart">Get Started &ensp;&RightArrow;</div></a>
            </div>
        ...
        <div class="pf-row">
            <div class="pf-tab animation-row">
                <div class="pf-tab-label">
                    ...
                    <h5>Limited Words</h5>
                    <h3>Free</h3>
                    <a href="#pricing"><div class="pf-tab-label-btn">Start free trial today &ensp;&RightArrow;</div></a>
                </div>
            ...
            <div class="pf-tab animation-row">
                <div class="pf-tab-label">
                    ...
                    <a href="#pricing"><div class="pf-tab-label-btn-blue">Start free trial today &ensp;&RightArrow;</div></a>
                </div>
                <div class="pf-tab-lists">
                    <ul class="list">
    ...
    <div class="footer">
        <div class="ft-div">
            <p>&copy; 2025 SilverAI. Designed by <a href="https://github.com/prancodes/Silver-AI" target="_blank" class="ft-name">Silver AI Teams</a></p>
            <div class="ft-icons">
